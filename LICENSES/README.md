...
README, 문제 해결 기록, 설정·개발 안내와 직접 만든 도표·문서용 화면 녹화는
...
세 앱의 `res/drawable-nodpi/ic_launcher_art*.png`와
`res/drawable-nodpi/ic_launcher_folded_v3.png`는 이 프로젝트에서 이미지 생성 도구로
...
아이콘의 파일 범위와 제작 방식은 [아이콘 안내](../docs/ICON-DESIGN.md)에 있습니다.
