...
[소음 제어의 동작 원리와 검사](docs/DEVELOPMENT.md#소음-제어와-위젯)
...
[화면 자료 출처](../../docs/images/README.md) · [아이콘 안내](../../docs/ICON-DESIGN.md)
...
[위젯 동작 원리](docs/DEVELOPMENT.md#배터리-위젯과-연결-카드)
...
[확인한 환경과 남은 시험](../../compatibility/README.md)
...
이 앱 폴더에서 실행합니다. 처음 준비한다면 [공통 빌드 안내](../../docs/GETTING-STARTED.md)를 참고하세요.

~~~sh
./test-core.sh
sh ./test-listening.sh
sh ./test-listening-widget.sh
./build.sh
./verify-apk.sh
~~~
...
구조·실패 사례·재검사 방법은 [개발 안내](docs/DEVELOPMENT.md),
실기기와 자동 검사의 차이는 [호환성 안내](../../compatibility/README.md)에 있습니다.
