...
- 2026-09-15 [소음 제어 과정](../design/021-listening-controls.md#4-의존성-순서에-따른-구현-과정):
  상태 계약→공유 연결→두 모드 실기 검증→적응형→아이콘·화면 자료 순으로 반영했다.
  현재 소스에 포함됐으며 APK 배포와 소음 제어 위젯은 별도 단계다.
