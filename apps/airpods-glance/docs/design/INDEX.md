...
- [021 — 앱에서 소음 제어](021-listening-controls.md): 노캔·적응형·주변음, 공유 연결·요청 수명,
  아이콘 수정 과정과 실제 기기/UI 검증. 소스 반영이며 APK 배포 전이다.

- [018 — 잠금화면 한 칸에서 부품 바꾸기](018-lock-screen-widgets.md):
  아이콘·탭 전환, 위젯별 선택 저장, 마지막 수신 잔량 표시와 Fold8 검증 범위.
