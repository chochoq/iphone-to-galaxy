...
**[APK 다운로드](https://github.com/chochoq/iphone-to-galaxy/releases/download/v0.0.3/holiday-sleep-0.0.3.apk)** · [설치 안내](../../docs/INSTALL.md)
...
공식 APK는 [GitHub Releases](https://github.com/chochoq/iphone-to-galaxy/releases/tag/v0.0.3)에서 받습니다.
