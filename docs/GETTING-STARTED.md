...
세 앱은 이미 APK로 만들어 Galaxy에 설치·시험했습니다. GitHub에는 다운로드용 APK를 아직 올리지
않았으므로, 현재 다른 사용자는 아래 순서로 소스를 직접 빌드해 설치할 수 있습니다.
...
USB 디버깅은 PC 연결 권한입니다. 설치한 앱의 권한은 앱을 열어 별도로 허용합니다.
사용할 기능에 필요한 항목만 켭니다.
...
캘린더 권한을 켜는 것과 대한민국 공휴일 캘린더를 동기화하는 것은 별개입니다.
